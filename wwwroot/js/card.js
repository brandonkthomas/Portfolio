...
class Card {
    ...
    constructor() {
        ...
        this.springStrength = 0.05; // legacy field (kept for backward compatibility)
        this.springDamping = 0.75; // legacy field (kept for backward compatibility)
        ...
        // Snap-back boost (temporary, snappy rubber-band on release)
        this.snapSpringStrength = 0.18;  // stronger spring for quick snap
        this.snapSpringDamping = 0.68;   // allow a tiny bit of bounce
        this.snapBoostDuration = 220;    // ms duration of the boosted snap-back
